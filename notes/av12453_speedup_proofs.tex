...
% -------------------------------------------------------------------------
% Draft supplement to
%   paper/av12453_polytime.tex  (Protected tails and polynomial-time enumeration of permutations avoiding a direct sum of an increasing pattern and 231)
%
% Self-contained: it compiles on its own with the preamble below.  That
% preamble adds only \Chat (= \widehat C) to the paper's, so the body can be
% pasted into the manuscript (after Section 7, "The two-threshold quotient
% for 12453") once \newcommand{\Chat}{\widehat C} has been added to the
% manuscript preamble.  All cross-references to the manuscript are by the
% manuscript's own labels (lem:d2-exact-support, lem:d2-translation,
% prop:kernel-recurrence, prop:scalar-kernel-recurrence, eq:R-recurrence,
% eq:K, eq:G, eq:rho, cor:d2-complexity, thm:main); compiling this file
% alone leaves those references undefined, which is expected.
%
% Every numbered claim below is either proved in full or carries an explicit
% MEASURED-ONLY flag.  Section 7 lists the machine checks and where they live.
% -------------------------------------------------------------------------
